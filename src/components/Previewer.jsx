...
const Previewer = ({ resumeData }) => {
	...
	return (
		<div className="my-5 mr-5 aspect-[8.5/11] rounded-md border-0 bg-white shadow-sm ring-1 ring-inset ring-gray-300">
			<div
				style={{ transform: `scale(${horizontalScale.toFixed(6)})` }}
				className="relative flex h-[11in] w-[8.5in] origin-top-left"
			>
