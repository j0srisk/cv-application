                ...
                {resumeData.projects.map((projectItem, index) => (
                    <div key={index} className="item">
                        <div className="flex justify-between">
                            <h3 className="text-xl font-bold leading-7 text-gray-900"> {projectItem.name ? projectItem.name : "Untitled"}</h3>
                            <button
                                type="button"
                                    ...
                                    <div key={subIndex}>
                                        <div className="flex gap-4">
                                            <input
                                                ...
                                                onChange={(e) => handleChange('projects', index, 'description', e.target.value, 'bullet', subIndex)}
                                                className="input"
                                            />
