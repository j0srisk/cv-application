...
function Editor ({ resumeData, setResumeData }){
    ...
    return (
        <div className="card">
            ...
            <p className="card-text">Add the name of your school, where it is located, what degree you obtained, your field of study, and your graduation year.</p>
                ...
                {resumeData.education.map((educationItem, index) => (
                    <div key={index} className="item">
                        ...
                        <div className="flex justify-between">
                            ...
                            <h3 className="item-title"> {educationItem.institution ? educationItem.institution : "Untitled"}</h3>
