...
function AdditionalInfo ({ resumeData, setResumeData, handleChange, removeItem }) {
    ...
    return (
        <div className="card">
            ...
            <p className="card-text">Include any additional information that you think is relevant to the job you are applying for.</p>
                ...
                {resumeData.additionalInfo.map((additionalInfoItem, index) => (
                    <div key={index} className="item">
                            <div className="flex justify-between">
                                ...
                                <h3 className="item-title"> {additionalInfoItem.name ? additionalInfoItem.name : "Untitled"}</h3>
                            ...
                            <div className="input-wrapper">
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleChange('additionalInfo', index, 'description', e.target.value)}
                                    className="input"
                                />
                            </div>
                    </div>
