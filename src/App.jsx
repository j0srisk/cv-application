    ...
    experience: [
      ...
      },
      {
        ...
        description: [
          ...
          {bullet: 'Presented research findings to C-suite executives, providing data-driven insights into industry trends and implications'},
          {bullet: 'Collaborated with DevOps team to assess the implementation of emerging technologies in the surety business'},
          {bullet: 'Analyzed various financial statements and supported underwriters in risk analysis through financial modeling techniques'},
        ],
      },
      {
        ...
        description: [
          {bullet: 'Gained valuable entrepreneurial experience through the establishment of a hemp processing and brokering venture'},
          {bullet: 'Ensured compliance with licensing and regulatory requirements by liaising with local authorities'},
          {bullet: 'Managed and implemented IT infrastructure, ensuring seamless business operations and data integrity'},
        ],
      }
    ],
    projects: [
      {
        ...
        endDate: 'Fall 2022',
        description: [
          {bullet: 'Developed a tailored application in collaboration with a local law firm to monitor potential conflicts of interest'},
          {bullet: 'Played an active role in the software development life cycle, gathering and analyzing business requirements'},
          {bullet: 'Served as a dedicated developer within an Agile team, emphasizing effective communication and iterative development'},
          {bullet: 'Integrated third-party APIs to automate processes and seamlessly connect the custom application with existing systems'},
        ],
      },
      {
        ...
        endDate: 'Spring 2022',
        description: [
          {bullet: 'Developed a full stack ASP.NET pseudo ecommerce site hosted on Microsoft Azure'},
          {bullet: 'Created a robust relational database schema, optimizing table relationships for efficient data management'},
          {bullet: 'Implemented various LINQ queries to facilitate seamless interaction with the cloud-hosted SQL relational database'},
          {bullet: 'Utilized Git version control for effective coordination of changes and feature implementations within the development team'},
        ],
      },
    ],
    awards: [
